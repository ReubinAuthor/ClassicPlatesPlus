...
function func:Update_Threat(unit)
    if unit and string.match(unit, "nameplate") then
        ...
        if nameplate then
            ...
            if Config.ThreatPercentage and ThreatPercentageOfLead > 0 then
            ...
            unitFrame.threatPercentage:SetShown(Config.ThreatPercentage and ThreatPercentageOfLead and ThreatPercentageOfLead > 0);

            -- Toggle for highlights
            local ShowHighlight = Config.ThreatHighlight
                and (ThreatPercentageOfLead > Config.ThreatWarningThreshold -- Above threat threshold
