...
function func:Load_Settings()
    ...
    -- Auras CheckButton, Hide passive auras
    local auras_CheckButton_HidePassiveAuras = CreateFrame("CheckButton", nil, panel_auras, "InterfaceOptionsCheckButtonTemplate");
    auras_CheckButton_HidePassiveAuras:SetPoint("topLeft", auras_DropdownMenu_AurasVisibility, "bottomLeft", 16, -4);
    auras_CheckButton_HidePassiveAuras.Text:SetText("Hide passive auras");
    auras_CheckButton_HidePassiveAuras:SetChecked(Config.HidePassiveAuras);
    auras_CheckButton_HidePassiveAuras:SetScript("OnClick", function(self)
        Config.HidePassiveAuras = self:GetChecked();
        func:Update();
    end);
    ...
    auras_CheckButton_AurasCountdown:SetPoint("topLeft", auras_CheckButton_HidePassiveAuras, "bottomLeft", 0, -4);
    ...
    auras_ImportantTitle:SetPoint("bottomLeft", panel_auras, "bottomLeft", 16, 285);
    ...
    auras_BLAurasTitle:SetPoint("bottomLeft", panel_auras, "bottomLeft", 326, 285);
